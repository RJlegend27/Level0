	...
	public static void main(String[] args) {
		...
		if (NFL.equalsIgnoreCase(JulioJones)) {
			JOptionPane.showMessageDialog(null,
					"Julio Jones stats last year were" + " 136 receptions, 1,871 yards, 8 Touchdowns, 93 first downs made!!!, and Averages 13.8 yards a series!!!");
		} else {
		}
		if (NFL.equalsIgnoreCase(AaronRodgers)) {
			JOptionPane.showMessageDialog(null,
					"Aaron Rodgers's stats last year were" + " 3,821 yards!, 31 Touchdowns Thrown, 1 rushing Touchdown," + " 8 interceptions, and Averages 6.7 yards a series");
		} else {
		}
		...
		if (NFL.equalsIgnoreCase(AdrianPeterson)) {
			JOptionPane.showMessageDialog(null, "Adrian Peterson's stats last year were" + "1,485 yards!, 11 Touchdowns!," + " 71 First downs!!!" + " Averages 4.5 yards a series");
			viking();
